...
const Cart: React.FC<IProps> = ({
  ...
  return (
    <div className="fixed top-0 left-0 z-10 bg-gradient-to-br from-indigo-400 to-indigo-600 h-screen w-screen text-white">
      <svg
      ...
      <div className="text-lg font-bold text-center mt-16">Your Cart</div>
      {cartItems.length === 0 ? (
